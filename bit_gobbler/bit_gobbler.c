...
static uint64_t PIXEL_FREQ = (25 * MHZ);
...
void pio_irq_handler() {
    ...
    pio_interrupt_clear(pio_0, sm0);
    // Alert the user (e.g., print to serial)
    printf("Hsync interrupt generated by PIO0 SM0!\n");
}
...
int main()
{
    ...
    hsync_program_init(pio_0, sm0, offset0, HSYNC_PIN);
    printf("Started hsync_program to fire irq0 on rising edge of pin %d\n", HSYNC_PIN);
    ...
    printf("Gobbler initialized on sm %d, running at %d\n", sm2, PIXEL_FREQ);
    ...
    pio_set_irq0_source_enabled(pio_0, sm0, true);
