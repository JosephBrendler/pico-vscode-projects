...
//#define CLOCK_DIVISOR 65535   // empirically, 2ms period
//#define CLOCK_DIVISOR 32767   // empirically, 1ms period
//#define CLOCK_DIVISOR 16383   // empirically, 0.52ms period
//#define CLOCK_DIVISOR 8091   // empirically, 260us period
//#define CLOCK_DIVISOR 4091   // empirically, 130us period
//#define CLOCK_DIVISOR 2048   // empirically, 66us period
//#define CLOCK_DIVISOR 1024   // empirically, 33us period
//#define CLOCK_DIVISOR 512   // empirically, 16.4us period
//#define CLOCK_DIVISOR 256   // empirically, 8.2us period
//#define CLOCK_DIVISOR 128   // empirically, 4.2us period
...
int main() {
    ...
    // run the programs for x5sx (1 min) then stop the state machines
    sleep_ms(60000);
    #if PICO_PIO_VERSION > 0
